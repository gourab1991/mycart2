<%-- 
    Document   : index
    Created on : 18-Nov-2022, 12:47:36 PM
    Author     : Gourab
--%>

<%@page import="com.learn.mycart2.helper.Helper"%>
<%@page import="com.learn.mycart2.entities.Category"%>
<%@page import="com.learn.mycart2.dao.CategoryDao"%>
<%@page import="java.util.List"%>
<%@page import="com.learn.mycart2.entities.Product"%>
<%@page import="com.mycompany.mycart2.dao.ProductDao"%>
<%@page import="com.learn.mycart2.helper.FactoryProvider"%>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card-columns">
                                ...
                                <div class="card product-card">
                                    ...
                                    <div card="card-footer text-center">
